...
class AddFrame(Frame):
    ...
    def createPage(self):
        ...
        Button(self, text='录  入', font=("楷体", 15, "bold"), command=self.add_books).grid(row=6, stick=W, column=1,
                                                                                            pady=20, padx=40)
...
class DeleteFrame(Frame):
    ...
    def createPage(self):
        ...
        Button(self, text='删  除', font=("楷体", 15, "bold"), command=self.delete_books).grid(row=6, stick=W, column=1,
                                                                                               pady=20, padx=30)
...
class CountFrame(Frame):
    ...
    def createPage(self):
        ...
        Entry(self, textvariable=self.book_Name, font=("楷体", 15, "bold")).grid(row=1, column=1, stick=E)
        Button(self, text='统  计', font=("楷体", 15, "bold"), command=self.count_books).grid(row=6, stick=W, column=1,
                                                                                              pady=20, padx=30)
    ...
    def count_books(self):
        ...
        Label(countWin, text='书    名：    ' + bookname, font=("楷体", 15, "bold")).grid(row=1, stick=W, pady=10,
                                                                                         padx=90)
        Label(countWin, text='总    数：    ' + str(count_all), font=("楷体", 15, "bold")).grid(row=2, stick=W, pady=15,
                                                                                               padx=90)
        Label(countWin, text='借出数量：    ' + str(count_lend) + '本', font=("楷体", 15, "bold")).grid(row=3, stick=W,
                                                                                                       pady=15, padx=90)
        Label(countWin, text='剩余数量：    ' + str(count_remain) + '本', font=("楷体", 15, "bold")).grid(row=4, stick=W,
                                                                                                         pady=15,
                                                                                                         padx=90)
...
class Register_admirFrame(Frame):
    ...
    def createPage(self):
        ...
        Entry(self, textvariable=self.admir_Password, font=("楷体", 15, "bold"), show='*').grid(row=2, column=1,
                                                                                                stick=E)
        Label(self, text='重新输入密码： ', font=("楷体", 15, "bold")).grid(row=3, stick=W, pady=15)
        Entry(self, textvariable=self.admir_Password_repetion, font=("楷体", 15, "bold"), show='#').grid(row=3,
                                                                                                         column=1,
                                                                                                         stick=E)
        Button(self, text='注册', font=("楷体", 15, "bold"), command=self.register_admir).grid(row=4, stick=W, column=1,
                                                                                               pady=20, padx=30)
