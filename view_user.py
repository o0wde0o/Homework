...
class QueryFrame(Frame):
    ...
    def createPage(self):
        ...
        Button(self, text='查  找', font=("宋体", 14, "bold"), command=self.find_book).grid(row=2, stick=W, column=1,
                                                                                            pady=20, padx=50)
    ...
    def find_book(self):
        ...
        if temp == 1:
            ...
            Label(bookWindow, text='编   号：' + bookid_txt, font=("宋体", 14, "bold")).grid(row=1, stick=W, pady=10,
                                                                                            padx=100)
            Label(bookWindow, text='书   名：' + bookname_txt, font=("宋体", 14, "bold")).grid(row=2, stick=W, pady=10,
                                                                                              padx=100)
            Label(bookWindow, text='作   者：' + bookwriter_txt, font=("宋体", 14, "bold")).grid(row=3, stick=W, pady=10,
                                                                                                padx=100)
            Label(bookWindow, text='数   量：' + booknum_txt + '  本', font=("宋体", 14, "bold")).grid(row=4, stick=W,
                                                                                                      pady=10, padx=100)
            Label(bookWindow, text='价   格：' + bookprice_txt + '  元', font=("宋体", 14, "bold")).grid(row=5, stick=W,
                                                                                                        pady=10,
                                                                                                        padx=100)
            bookWindow.mainloop()
        elif temp == 2:
...
class BorrowFrame(Frame):
    ...
    def createPage(self):
        ...
        Button(self, text='借  书', font=("宋体", 14, "bold"), command=self.borrow_book).grid(row=4, stick=W, column=1,
                                                                                              pady=20, padx=50)
...
class ReturnFrame(Frame):
    ...
    def createPage(self):
        ...
        Label(self, text='密  码： ', font=("宋体", 14, "bold")).grid(row=3, stick=W, pady=20)
        Entry(self, textvariable=self.user_Password_re, show='*', font=("宋体", 14, "bold")).grid(row=3, column=1,
                                                                                                  stick=E)
        Button(self, text='还  书', font=("宋体", 14, "bold"), command=self.return_book).grid(row=4, stick=W, column=1,
                                                                                              pady=20, padx=50)
                ...
                with open('book_lend.txt', 'w') as fw1:
                    for line1 in lines1:
                        ...
                        if v[0] == bookname and v[1] == username and sign == 0:
                            ...
                            Label(borrowWin, text='书    名：' + bookname, font=("宋体", 14, "bold")).grid(row=1,
                                                                                                          stick=W,
                                                                                                          pady=10,
                                                                                                          padx=100)
                            Label(borrowWin, text='用    户：' + username, font=("宋体", 14, "bold")).grid(row=2,
                                                                                                          stick=W,
                                                                                                          pady=10,
                                                                                                          padx=100)
                            Label(borrowWin, text='借出日期：' + list2[0] + '年' + list2[1] + '月' + list2[2] + '日',
                                  font=("宋体", 14, "bold")).grid(row=3, stick=W, pady=10, padx=100)
                            Label(borrowWin, text='借出天数：' + str(date) + '  天', font=("宋体", 14, "bold")).grid(
                                row=4, stick=W, pady=10, padx=100)
                            continue
                        fw1.write(line1)
                fr1.close()
                fw1.close()
