...
class Register_Page(object):
    ...
    def createPage(self):
        ...
        Entry(self.page, textvariable=self.userpassword, font=("楷体", 15, "bold"), show='*').grid(row=3, column=1,
                                                                                                   stick=E)
        Label(self.page, text='重新输入密码： ', font=("楷体", 15, "bold")).grid(row=4, stick=W, pady=15)
        Entry(self.page, textvariable=self.userpasswordre, font=("楷体", 15, "bold"), show='#').grid(row=4, column=1,
                                                                                                     stick=E)
        Button(self.page, text='注册', font=("楷体", 15, "bold"), command=self.register_admir).grid(row=5, stick=W,
                                                                                                    column=1, pady=20,
                                                                                                    padx=30)
